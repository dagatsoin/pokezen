    ...
    Details.prototype.render = function () {
        ...
        return this.pokemon ? (React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column" } },
            ...
            React.createElement("div", { style: { display: "flex", justifyContent: "center" } },
                React.createElement(List, { style: { width: "200px" } },
                    React.createElement(ListItem, null,
                        React.createElement("h3", { style: { margin: 0, textAlign: "center" } }, "Base Stats")),
                    React.createElement(ListItem, null,
                        React.createElement("div", { style: { display: "flex", justifyContent: "center" } }, this.pokemon.types.map(function (pokemonType) { return (React.createElement(Type, { type: pokemonType.type.name, key: pokemonType.type.url })); }))),
                    ...
                    this.pokemon.stats.map(function (pokemonStat) { return (React.createElement(ListItem, { key: pokemonStat.stat.name },
                        React.createElement("div", { style: { display: "flex", justifyContent: "space-between" } },
                            React.createElement("span", { style: { color: "#999", textAlign: "left" } }, pokemonStat.stat.name),
                            React.createElement("span", { style: { textAlign: "right" } }, pokemonStat.base_stat)))); })),
                this.types.map(function (typeId) {
                    ...
                    return averageStats ? (React.createElement(List, { key: typeId, style: { width: "133px", justifyContent: "center" } },
                        React.createElement(ListItem, null,
                            React.createElement("div", { style: { display: "flex", justifyContent: "center" } },
                                React.createElement("h4", { style: { margin: 0, width: "100px" } }, "Type Average"))),
                        React.createElement(ListItem, null,
                            React.createElement("div", { style: { display: "flex", justifyContent: "center" } },
                        ...
                        averageStats.stats.map(function (stat) { return (React.createElement(ListItem, { key: stat.name },
                            React.createElement("div", { style: { display: "flex", justifyContent: "center" } }, stat.value))); }))) : React.createElement(CircularProgress, { key: typeId, size: 30, thickness: 3 });
                })),
            React.createElement("div", { style: { display: "flex", justifyContent: "center" } },
